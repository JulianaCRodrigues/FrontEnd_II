// função para ativar mudança de modo conforme o click do botão;
// liga e desliga coconforme está ou não o modo dark
...
const containertRef = document.querySelector("#container");

const felinos = [
  {
    imagem: "./imagens/tiger.jpg",
    titulo: "O tigre ",
    descricao: `O tigre (Panthera tigris) é uma das espécies da subfamília Pantherinae
    (família Felidae) pertencente ao gênero Panthera. É encontrado de
    forma nativa apenas no continente asiático; é um predador carnívoro e
  ...
  },
  {
    ...
    selva da Bacia do Congo) e uma pequena área do noroeste da Índia.`,
  },
  {
    ...
    e, quando tem a pelagem completamente escura, como pantera negra
    (melanista).`,
  },
